...
{
    /// <summary>
    /// Class containing system error code constants and method to convert them to a string.
    /// </summary>
    /// <remarks>
    /// http://msdn.microsoft.com/en-us/library/ms681382%28VS.85%29.aspx
    /// http://pcsupport.about.com/od/findbyerrormessage/tp/system_error_codes_1200_1299.01.htm
    /// </remarks>
    static public class SystemErrorCodes
    {
        ...
        static public string ToString(int errorCode)
        {
            switch (errorCode)
            {
                ...
                // Added by Andy
                case 1210: return "The format of the specified computer name is invalid.";
                case 1211: return "The format of the specified event name is invalid.";
                case 1212: return "The format of the specified domain name is invalid.";
                case 1213: return "The format of the specified service name is invalid.";
                case 1214: return "The format of the specified network name is invalid.";
                case 1215: return "The format of the specified share name is invalid.";
                case 1216: return "The format of the specified password is invalid.";
                case 1217: return "The format of the specified message name is invalid.";
                case 1218: return "The format of the specified message destination is invalid.";
